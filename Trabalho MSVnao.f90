...
common/dados/cond,t1,t2,critconv       ! Constantes e critério de convergencia
...
!************************************************************************      
subroutine coefcc (x,y,ae,aw,an,as,ap,t) !Coeficientes e condições de contorno
!------------------------------------------------------------------------
...
do i=2,l2	! Condições de contorno (fluxo prescrito)
...
!************************************************************************      
subroutine tincc (x,y,ae,aw,an,as,ap,t) !Temperatura inicial e condições de contorno
!------------------------------------------------------------------------
...
!DO I=L1,L2   ! Cálculo de Q, o calor gerado fonte 1
 !DO J=2,M2
  !SC(I,J)=qd*dx*dy
 !ENDDO
!ENDDO
...
DO J=2,M2
  !CALORW=CALORW+cond*dy*(T(1,J)-T(2,J))/(dx/2.d0)    ! CONVENÇÃO DE TRANSCAL
